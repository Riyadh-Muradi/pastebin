...
const Footer = () => {
  return (
    <footer className="relative bottom-0 z-40 flex w-[99%] items-center justify-between rounded-2xl bg-white px-2 py-4 pb-3 text-2xl shadow-sm sm:px-6 md:px-4 lg:px-6">
